...
/***/ "./src/constans/index.ts":
/*!*******************************!*\
  !*** ./src/constans/index.ts ***!
  \*******************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"emojis\": () => (/* binding */ emojis)\n/* harmony export */ });\nvar emojis = [\"😀\", \"😀\", \"😇\", \"😇\", \"🙂\", \"🙂\", \"😝\", \"😝\", \"🙃\", \"🙃\", \"😁\", \"😁\", \"🤞\", \"🤞\", \"👎 \", \"👎 \", \"🤜\", \"🤜\", \"👏\", \"👏\", \"👧\", \"👧\", \"😑\", \"😑\", \"😞\", \"😞\", \"🥲\", \"🥲\", \"😂\", \"😂\", \"😊\", \"😊\", \"😵\", \"😵\", \"💩\", \"💩\", \"😾\", \"😾\", \"😹\", \"😹\", \"😼\", \"😼\", \"💀\", \"💀\", \"🤧\", \"🤧\", \"😷\", \"😷\", \"🤒\", \"🤒\", \"🤕\", \"🤕\", \"🥱\", \"🥱\", \"😪\", \"😪\", \"😡\", \"😡\", \"🤬\", \"🤬\", \"🤯\", \"🤯\", \"🤖\", \"🤖\", \"😈\", \"😈\", \"👹\", \"👹\", \"🥶\", \"🥶\", \"😎\", \"😎\", \"🎃\", \"🎃\", \"🐶\", \"🐶\", \"🐱\", \"🐱\", \"🐭\", \"🐭\", \"🐹\", \"🐹\", \"🐰\", \"🐰\", \"🦊\", \"🦊\", \"🐻\", \"🐻\", \"🐼\", \"🐼\", \"🐻‍❄️\", \"🐻‍❄️\", \"🐨\", \"🐨\", \"🐯\", \"🐯\", \"🐮\", \"🐮\", \"🐷\", \"🐷\", \"🦉\", \"🦉\", \"🦇\", \"🦇\", \"🐺\", \"🐺\", \"🌞\", \"🌞\", \"🌝\", \"🌝\", \"🌛\", \"🌛\", \"🌜\", \"🌜\", \"🌚\", \"🌚\", \"🌕\", \"🌕\", \"🌒\", \"🌒\", \"⚡️\", \"⚡️\", \"🌤\", \"🌤\", \"🌎\", \"🌎\", \"☔️\", \"☔️\", \"🌨\", \"🌨\", \"🌈\", \"🌈\", \"🍟\", \"🍟\", \"🍜\", \"🍜\", \"🍥\", \"🍥\", \"🍘\", \"🍘\", \"🍬\", \"🍬\", \"🥇\", \"🥇\"];\n\n\n//# sourceURL=webpack://js-task/./src/constans/index.ts?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _styles_index_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles/index.css */ \"./src/styles/index.css\");\n/* harmony import */ var _constans__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./constans */ \"./src/constans/index.ts\");\n\n\nvar PlayMemory = /** @class */ (function () {\n    function PlayMemory() {\n        this.selectMenuItems = Array.from(document.querySelectorAll(\".selector-item\"));\n        this.buttons = Array.from(document.querySelectorAll(\".inner-popup button\"));\n        this.selectorMenu = document.querySelector(\"#selector\");\n        this.selector = document.querySelector(\".selector-value\");\n        this.innerContainer = document.querySelector(\"#inner-container\");\n        this.finishedTextPopup = document.querySelector(\".timer-popup\");\n        this.chosenLevelPopup = document.querySelector(\".popup\");\n        this.level = \"\";\n        this.totalSeconds;\n        this.startTimerFromZero = 0;\n        this.cardsOnTable = [];\n        this.interval;\n        this.gamefinishedText;\n    }\n    PlayMemory.prototype.play = function () {\n        var _this = this;\n        this.buttons.forEach(function (button) {\n            button.addEventListener(\"click\", function () {\n                if (button.className !== \"selector-value\") {\n                    _this.level = button.dataset.level;\n                    _this.getLevel();\n                }\n            });\n        });\n        this.selector.addEventListener(\"click\", function () {\n            _this.selectorMenu.classList.toggle(\"active-menu\");\n        });\n        this.selectMenuItems.forEach(function (item) {\n            item.addEventListener(\"click\", function () {\n                _this.selectorMenu.classList.remove(\"active-menu\");\n                _this.selector.innerHTML = \"<p>\".concat(item.textContent, \"&#x21d3;</p>\");\n                var customLevel = item.dataset.level;\n                _this.level = customLevel;\n                _this.getLevel();\n            });\n        });\n    };\n    PlayMemory.prototype.startTimer = function () {\n        var _this = this;\n        this.totalSeconds = 0;\n        this.interval = setInterval(function () {\n            ++_this.totalSeconds;\n            var hour = Math.floor(_this.totalSeconds / 3600);\n            var minute = Math.floor((_this.totalSeconds - hour * 3600) / 60);\n            var seconds = _this.totalSeconds - (hour * 3600 + minute * 60);\n            if (hour < 10)\n                hour = \"0\" + hour;\n            if (minute < 10)\n                minute = \"0\" + minute;\n            if (seconds < 10)\n                seconds = \"0\" + seconds;\n            _this.gamefinishedText = \"<div>\\n      <p>Congrats you finished this level in</p>\\n      <p>\".concat(hour, \": \").concat(minute, \": \").concat(seconds, \"</p>\\n      </div>\");\n        }, 1000);\n    };\n    PlayMemory.prototype.getLevel = function () {\n        this.startTimerFromZero = 0;\n        clearInterval(this.interval);\n        this.level === \"2\"\n            ? (this.cardsOnTable = _constans__WEBPACK_IMPORTED_MODULE_1__.emojis.slice(0, 4).sort(function () { return Math.random() - 0.5; }))\n            : null;\n        this.level === \"6\"\n            ? (this.cardsOnTable = _constans__WEBPACK_IMPORTED_MODULE_1__.emojis.slice(0, 36).sort(function () { return Math.random() - 0.5; }))\n            : null;\n        this.level === \"10\"\n            ? (this.cardsOnTable = _constans__WEBPACK_IMPORTED_MODULE_1__.emojis.slice(0, 100).sort(function () { return Math.random() - 0.5; }))\n            : null;\n        this.level === \"eazy\"\n            ? (this.cardsOnTable = _constans__WEBPACK_IMPORTED_MODULE_1__.emojis.slice(0, 16).sort(function () { return Math.random() - 0.5; }))\n            : null;\n        this.level === \"medium\"\n            ? (this.cardsOnTable = _constans__WEBPACK_IMPORTED_MODULE_1__.emojis.slice(0, 64).sort(function () { return Math.random() - 0.5; }))\n            : null;\n        this.level === \"hard\"\n            ? (this.cardsOnTable = _constans__WEBPACK_IMPORTED_MODULE_1__.emojis.sort(function () { return Math.random() - 0.5; }))\n            : null;\n        this.innerContainer.className = \"\";\n        this.innerContainer.classList.add(\"prison\".concat(this.level));\n        this.addCard(this.cardsOnTable);\n    };\n    PlayMemory.prototype.addCard = function (cardsOnTable) {\n        var _this = this;\n        this.innerContainer.innerHTML = \"\";\n        this.cardsOnTable.map(function (item) {\n            var card = document.createElement(\"div\");\n            card.className = \"card\";\n            var frontSide = document.createElement(\"div\");\n            frontSide.className = \"card-face card-front\";\n            var backSide = document.createElement(\"div\");\n            backSide.innerText = \"\".concat(item);\n            backSide.className = \"card-face card-back\";\n            card.appendChild(frontSide);\n            card.appendChild(backSide);\n            _this.innerContainer.appendChild(card);\n        });\n        this.cardClick();\n    };\n    PlayMemory.prototype.cardClick = function () {\n        var _this = this;\n        var cards = document.querySelectorAll(\".card\");\n        var history = [];\n        cards.forEach(function (card, index) {\n            card.addEventListener(\"click\", function (e) {\n                card.classList.add(\"rototate-card\");\n                _this.startTimerFromZero += 1;\n                if (_this.startTimerFromZero === 1) {\n                    _this.chosenLevelPopup.classList.add('hide-popup');\n                    _this.startTimer();\n                }\n                history.push({\n                    text: e.path[1].innerText,\n                    index: index,\n                });\n                if (history.length === _this.cardsOnTable.length) {\n                    clearInterval(_this.interval);\n                    _this.startTimerFromZero = 0;\n                    _this.finishedTextPopup.classList.add(\"active\");\n                    _this.finishedTextPopup.innerHTML = _this.gamefinishedText;\n                    history = [];\n                    setTimeout(function () {\n                        _this.finishedTextPopup.classList.remove(\"active\");\n                        cards.forEach(function (item) {\n                            item.classList.remove(\"rototate-card\");\n                            _this.chosenLevelPopup.classList.remove('hide-popup');\n                        });\n                        _this.getLevel();\n                    }, 3000);\n                }\n                if (history.length > 1) {\n                    history.map(function (item, index) {\n                        if (index !== 0 &&\n                            item.text === history[index - 1].text &&\n                            index % 2) {\n                            return null;\n                        }\n                        else if (index !== 0 && index % 2) {\n                            var removeActive = history.slice(-2);\n                            removeActive.forEach(function (item) {\n                                setTimeout(function () {\n                                    cards[item.index].classList.remove(\"rototate-card\");\n                                }, 700);\n                            });\n                            history.splice(history.length - 2, 2);\n                        }\n                    });\n                }\n            });\n        });\n    };\n    return PlayMemory;\n}());\nvar game = new PlayMemory();\ngame.play();\n\n\n//# sourceURL=webpack://js-task/./src/index.ts?");
